...
import { Sidebar, SidebarContent, SidebarGroup, SidebarHeader, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarGroupContent, SidebarSeparator, SidebarFooter, SidebarGroupLabel } from "@/components/ui/sidebar";
                    ...
                    <DropdownMenuTrigger asChild>
                        <SidebarMenuButton size="lg" className="data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground">
                            <Avatar className="h-8 w-8 rounded-lg grayscale">
                                <AvatarFallback className="rounded-lg">{session.data?.user?.name.charAt(0)}{session.data?.user?.name.charAt(1)}</AvatarFallback>
                            </Avatar>
