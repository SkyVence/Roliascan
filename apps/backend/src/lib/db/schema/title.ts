...
import { PgSchema, text, timestamp, uuid, varchar, PgTableWithColumns, primaryKey } from "drizzle-orm/pg-core";
...
export const defineTitleTables = (schema: PgSchema<any>) => {
    ...
    const titleToGenre = schema.table("title_to_genre", {
    ...
    return { title, titleRelations, titleLinks, titleLinksRelations, titleToGenre, titleToGenreRelations };
};